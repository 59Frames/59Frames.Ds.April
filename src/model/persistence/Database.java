...
public class Database extends BaseContext {
    ...
    private static final String HOST = String.format("jdbc:mysql://%s:%d/%s?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Europe/Zurich&allowMultiQueries=true", RAW_HOST, PORT, DATABASE);
