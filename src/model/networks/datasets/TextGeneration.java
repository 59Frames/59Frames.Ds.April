...
public class TextGeneration extends DataSet {
    ...
    public static List<String> generateText(NetworkModel model, int steps, boolean argmax, double temperature, Random rng) throws Exception {
    ...
    public static String sequenceToSentence(DataSequence sequence) {
        ...
        for (int s = 0; s < sequence.getSteps().size() - 1; s++) {
            DataStep step = sequence.getSteps().get(s);
            int index = -1;
