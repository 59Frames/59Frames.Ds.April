...
public class LossSoftmax implements Loss {
    ...
    public void backward(Matrix logprobs, Matrix targetOutput) throws Exception {
        ...
        System.arraycopy(probs.w, 0, logprobs.dw, 0, probs.w.length);
    ...
    public static double calculateMedianPerplexity(NetworkModel model, List<DataSequence> sequences) throws Exception {
